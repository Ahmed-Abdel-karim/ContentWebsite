      ...
      <div className={navStyles.navbarMain}>
        <div className={navStyles.up}>
          <div className={navStyles.upCont}>
            <div className={navStyles.other}>
              <div
                className={` ${navStyles.lang} ${
                  lang == "en" ? navStyles.en : ""
                }`}
              >
                <div
                  className={`${navStyles.en} ${
                    lang == "en" ? navStyles.disable : ""
                  }`}
                  onClick={() =>
                    lang == "ar"
                      ? (setFlag(true),
                ...
                <div
                  className={`${navStyles.ar} ${
                    lang == "ar" ? navStyles.disable : ""
                  }`}
                  onClick={() =>
                    lang == "en"
                      ? (setFlag(true),
            ...
            <div className={navStyles.contact}>
              {contact.hotline != "" ? (
                <div
                  className={`${navStyles.contactElem} ${
                    lang == "en" ? navStyles.en : ""
                  }`}
                >
        ...
        <div className={navStyles.sticky}>
              ...
              <li key={listItem.id}>
                ...
                <div className={navStyles.NavList}>
                  {listItem.cities.map((item) => (
                    <a
                      href={`/projects/${listItem.propertyUrl}/${item.cityUrl}`}
                      key={item.id}
                    >
                      <div className={navStyles.NavListItem} key={item.id}>
                        {item.name}
                      </div>
                    </a>
                  ))}
          ...
          <div
            ...
            onClick={() => setBurgerVisability(!burgerVisability)}
          >
