...
const ProRealStateCard = ({ city, lang }) => {
  return (
    <>
      <Link
        href={`/projects/${city.propertyUrl}/${
          city.cityName
      ...
      >
        <a className={styles.outerLink}>
          <Desktop>
            <div className="pc">
              <img
                src={city.pcImage ? city.pcImage : ""}
                alt=""
                className={styles.ProRealeStateCard}
                loading="lazy"
              />
            </div>
          </Desktop>
          ...
          <div
            className={`${styles.ProRealeStateInfo} ${
              lang == "en" ? styles.en : ""
            }`}
          >
            <h2 className={styles.ProRealeStateName}>{city.name}</h2>
            <h3
              className={`${styles.ProRealeStateCount} ${
                lang == "en" ? styles.en : ""
              }`}
            >
              {lang == "ar" ? (
