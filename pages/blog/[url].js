          ...
          <div className={styles.blog_cont}>
            ...
            >
              ...
              <div className="share">
                ...
                <div className="share_contaier">
                  <Link
                    href={`https://www.facebook.com/sharer.php?u=${urllink}`}
                  >
                    <a target="_blank">
                  ...
                  <Link
                    href={`https://www.linkedin.com/shareArticle?url=${urllink}&title=${data.name}`}
                  >
                    <a target="_blank">
                      <svg
                        width="20"
                  ...
                  <Link
                    href={`https://twitter.com/share?url=${urllink}&text=${data.name}`}
                  >
                    <a target="_blank">
            ...
            <div className={styles.aside_container}>
              ...
              >
                ...
                <div className={styles.blogsProjects}>
                  {data.relatedBlogs &&
                    data.relatedBlogs.map((blog) => (
                      <div className="blogsProjectsListing" key={blog.id}>
                        <BlogsCard
                          blog={blog}
                          listing="insideblog"
                          lang={lang}
                ...
                <div className={styles.blogsProjects}>
                  {data.relatedProjects &&
                    data.relatedProjects.map((project) => (
                      <div className="blogsProjectsListing" key={project.id}>
